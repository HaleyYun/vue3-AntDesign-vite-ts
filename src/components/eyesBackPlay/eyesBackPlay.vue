    ...
    <div class="all-box" ref="boxAttr">
        ...
        <div class="number-count" v-if="isShowNumber">
            <div class="numberpic-box add-animate" v-show="countOne">
                <img class="yuan" src="../../static/images/yuan.png" alt="" />
                <img class="one-pic" src="../../static/images/1.png" alt="" />
            </div>
            <div class="numberpic-box add-animate" v-show="countTwo">
                <img class="yuan" src="../../static/images/yuan.png" alt="" />
                <img class="two-pic" src="../../static/images/2.png" alt="" />
            </div>
            <div class="numberpic-box add-animate" v-show="countThree">
                <img class="yuan" src="../../static/images/yuan.png" alt="" />
                <img class="three-pic" src="../../static/images/3.png" alt="" />
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        playBackList() {
            ...
            const that = this;
            that.lookArr = [];
            let isAttentionLook = getDrawEstimateVideo;
